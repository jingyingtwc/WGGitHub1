...
<asp:Content ID="Content" ContentPlaceHolderID="Content" runat="server">
    ...
    <div style="position: relative; width: 99vw; height: 55vw;padding:0;margin:0">
        ...
        <div style="width: 28.571%; height: 45.238%; position: absolute; right: 0px; top: 0px;">
            <a href="search.aspx">
                <img width="100%" alt="You can find the date that your rubbish will be collected! Don't forget to tell your mom!" src="images/collectionicon.png" /></a>
        </div>

        <!-- bottom left / disposal -->
        <div style="width: 27.311%; height: 47.619%; position: absolute; left: 0px; bottom: 0px;">
            <a href="disposal.aspx">
